...
def chat(username):
    ...
    data = [document for document in mycollection.find({}, fields)]
    def dataa():
        data = [document for document in mycollection.find({}, fields)]
    ...
    while True:
        ...
        for change in change_stream:
            if change["operationType"] in ["insert", "update"]:
                ...
                print(tabulate.tabulate([{a['Sender'],a['Message']}], headers=["Sender","Message                                 "], tablefmt="grid"))
                #print({a['Sender'],a['Message']},data)
